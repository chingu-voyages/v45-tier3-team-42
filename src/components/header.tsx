...
const userNavigation = [
  ...
  { name: 'New Item / My Items', href: '/my-items' },
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex items-center">
                      ...
                      <Link href="/">
                        <h1 className="text-3xl font-bold ml-2 text-main-500 ">EcoBagain</h1>
                      </Link>
                    </div>
{/* 
                  ...
                  <div className="hidden bg-red-500 md:block">
                    ...
                    <div className="flex items-center">
                      ...
                      <button
                        type="button"
                        title='Store map'
                        className="relative rounded-full bg-gray-800 ml-2 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                      >
                  ...
                  <div className="-mr-2 flex md:hidden">
                    ...
                    <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      {open ? (
                        ...
                        <HiMiniBars3 className="block h-6 w-6" aria-hidden="true" />
                      )}
                    </Disclosure.Button>
                  </div>
                </div>
